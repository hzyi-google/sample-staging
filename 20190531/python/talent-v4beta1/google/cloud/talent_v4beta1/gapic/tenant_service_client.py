...
class TenantServiceClient(object):
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=tenant_service_grpc_transport.
    ...
    def create_tenant(self,
        ...
        if 'create_tenant' not in self._inner_api_calls:
            self._inner_api_calls[
                'create_tenant'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.create_tenant,
                    default_retry=self._method_configs['CreateTenant'].retry,
                    default_timeout=self._method_configs['CreateTenant'].
                    timeout,
                    client_info=self._client_info,
                )

        request = tenant_service_pb2.CreateTenantRequest(
            parent=parent,
            tenant=tenant,
        )
        if metadata is None:
        ...
        return self._inner_api_calls['create_tenant'](request,
                                                      retry=retry,
                                                      timeout=timeout,
                                                      metadata=metadata)
    ...
    def get_tenant(self,
        ...
        if 'get_tenant' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_tenant'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['get_tenant'](request,
                                                   retry=retry,
                                                   timeout=timeout,
                                                   metadata=metadata)
    ...
    def update_tenant(self,
        ...
        if 'update_tenant' not in self._inner_api_calls:
            self._inner_api_calls[
                'update_tenant'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.update_tenant,
                    default_retry=self._method_configs['UpdateTenant'].retry,
                    default_timeout=self._method_configs['UpdateTenant'].
                    timeout,
                    client_info=self._client_info,
                )
        ...
        return self._inner_api_calls['update_tenant'](request,
                                                      retry=retry,
                                                      timeout=timeout,
                                                      metadata=metadata)
    ...
    def delete_tenant(self,
        ...
        if 'delete_tenant' not in self._inner_api_calls:
            self._inner_api_calls[
                'delete_tenant'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.delete_tenant,
                    default_retry=self._method_configs['DeleteTenant'].retry,
                    default_timeout=self._method_configs['DeleteTenant'].
                    timeout,
                    client_info=self._client_info,
                )
        ...
        self._inner_api_calls['delete_tenant'](request,
                                               retry=retry,
                                               timeout=timeout,
                                               metadata=metadata)
    ...
    def list_tenants(self,
        ...
        if 'list_tenants' not in self._inner_api_calls:
            self._inner_api_calls[
                'list_tenants'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.list_tenants,
                    default_retry=self._method_configs['ListTenants'].retry,
                    default_timeout=self._method_configs['ListTenants'].
                    timeout,
                    client_info=self._client_info,
                )
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_tenants'],
                                     retry=retry,
                                     timeout=timeout,
                                     metadata=metadata),
            request=request,
