...
class JobServiceClient(object):
    ...
    def create_job(self,
        ...
        return self._inner_api_calls['create_job'](request,
                                                   retry=retry,
                                                   timeout=timeout,
                                                   metadata=metadata)
    ...
    def list_jobs(self,
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_jobs'],
                                     retry=retry,
                                     timeout=timeout,
                                     metadata=metadata),
            request=request,
    ...
    def batch_delete_jobs(self,
        ...
        self._inner_api_calls['batch_delete_jobs'](request,
                                                   retry=retry,
                                                   timeout=timeout,
                                                   metadata=metadata)
    ...
    def search_jobs(self,
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['search_jobs'],
                                     retry=retry,
                                     timeout=timeout,
                                     metadata=metadata),
            request=request,
