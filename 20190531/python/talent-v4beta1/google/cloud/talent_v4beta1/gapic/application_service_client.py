...
from google.cloud.talent_v4beta1.gapic.transports import application_service_grpc_transport
...
class ApplicationServiceClient(object):
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=application_service_grpc_transport.
    ...
    def create_application(self,
        ...
        if 'create_application' not in self._inner_api_calls:
            self._inner_api_calls[
                'create_application'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.create_application,
                    default_retry=self._method_configs['CreateApplication'].
                    retry,
                    default_timeout=self._method_configs['CreateApplication'].
                    timeout,
        ...
        return self._inner_api_calls['create_application'](request,
                                                           retry=retry,
                                                           timeout=timeout,
                                                           metadata=metadata)
    ...
    def get_application(self,
        ...
        if 'get_application' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_application'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_application,
                    default_retry=self._method_configs['GetApplication'].retry,
                    default_timeout=self._method_configs['GetApplication'].
                    timeout,
                    client_info=self._client_info,
                )
        ...
        return self._inner_api_calls['get_application'](request,
                                                        retry=retry,
                                                        timeout=timeout,
                                                        metadata=metadata)
    ...
    def update_application(self,
        ...
        if 'update_application' not in self._inner_api_calls:
            self._inner_api_calls[
                'update_application'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.update_application,
                    default_retry=self._method_configs['UpdateApplication'].
                    retry,
                    default_timeout=self._method_configs['UpdateApplication'].
                    timeout,
                    client_info=self._client_info,
                )
        ...
        return self._inner_api_calls['update_application'](request,
                                                           retry=retry,
                                                           timeout=timeout,
                                                           metadata=metadata)
    ...
    def list_applications(self,
        ...
        if 'list_applications' not in self._inner_api_calls:
            self._inner_api_calls[
                'list_applications'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.list_applications,
                    default_retry=self._method_configs['ListApplications'].
                    retry,
                    default_timeout=self._method_configs['ListApplications'].
                    timeout,
                    client_info=self._client_info,
                )
