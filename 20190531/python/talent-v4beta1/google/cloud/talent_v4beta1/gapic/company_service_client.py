...
class CompanyServiceClient(object):
    ...
    def create_company(self,
        ...
        return self._inner_api_calls['create_company'](request,
                                                       retry=retry,
                                                       timeout=timeout,
                                                       metadata=metadata)
    ...
    def get_company(self,
        ...
        return self._inner_api_calls['get_company'](request,
                                                    retry=retry,
                                                    timeout=timeout,
                                                    metadata=metadata)
    ...
    def update_company(self,
        ...
        return self._inner_api_calls['update_company'](request,
                                                       retry=retry,
                                                       timeout=timeout,
                                                       metadata=metadata)
    ...
    def delete_company(self,
        ...
        self._inner_api_calls['delete_company'](request,
                                                retry=retry,
                                                timeout=timeout,
                                                metadata=metadata)
    ...
    def list_companies(self,
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_companies'],
                                     retry=retry,
                                     timeout=timeout,
                                     metadata=metadata),
            request=request,
