...
class ProfileServiceClient(object):
    ...
    def list_profiles(self,
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_profiles'],
                                     retry=retry,
                                     timeout=timeout,
                                     metadata=metadata),
            request=request,
    ...
    def create_profile(self,
        ...
        return self._inner_api_calls['create_profile'](request,
                                                       retry=retry,
                                                       timeout=timeout,
                                                       metadata=metadata)
    ...
    def get_profile(self,
        ...
        return self._inner_api_calls['get_profile'](request,
                                                    retry=retry,
                                                    timeout=timeout,
                                                    metadata=metadata)
    ...
    def delete_profile(self,
        ...
        self._inner_api_calls['delete_profile'](request,
                                                retry=retry,
                                                timeout=timeout,
                                                metadata=metadata)
    ...
    def search_profiles(self,
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['search_profiles'],
                                     retry=retry,
                                     timeout=timeout,
                                     metadata=metadata),
            request=request,
