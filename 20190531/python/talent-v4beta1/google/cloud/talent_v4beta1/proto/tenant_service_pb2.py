...
from google.cloud.talent_v4beta1.proto import tenant_pb2 as google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_tenant__pb2
...
_CREATETENANTREQUEST.fields_by_name['tenant'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_tenant__pb2._TENANT
_UPDATETENANTREQUEST.fields_by_name['tenant'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_tenant__pb2._TENANT
_UPDATETENANTREQUEST.fields_by_name['update_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
_LISTTENANTSRESPONSE.fields_by_name['tenants'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_tenant__pb2._TENANT
_LISTTENANTSRESPONSE.fields_by_name['metadata'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._RESPONSEMETADATA
...
ListTenantsRequest = _reflection.GeneratedProtocolMessageType('ListTenantsRequest', (_message.Message,), dict(
...
ListTenantsResponse = _reflection.GeneratedProtocolMessageType('ListTenantsResponse', (_message.Message,), dict(
...
_TENANTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002)\"$/v4beta1/{parent=projects/*}/tenants:\001*'),
  ),
  _descriptor.MethodDescriptor(
    name='GetTenant',
    ...
    output_type=google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_tenant__pb2._TENANT,
    serialized_options=_b('\202\323\344\223\002&\022$/v4beta1/{name=projects/*/tenants/*}'),
  ),
  _descriptor.MethodDescriptor(
    name='UpdateTenant',
    ...
    output_type=google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_tenant__pb2._TENANT,
    serialized_options=_b('\202\323\344\223\00202+/v4beta1/{tenant.name=projects/*/tenants/*}:\001*'),
  ),
  _descriptor.MethodDescriptor(
    name='DeleteTenant',
    ...
    serialized_options=_b('\202\323\344\223\002&*$/v4beta1/{name=projects/*/tenants/*}'),
  ),
  _descriptor.MethodDescriptor(
    name='ListTenants',
    ...
    serialized_options=_b('\202\323\344\223\002&\022$/v4beta1/{parent=projects/*}/tenants'),
  ),
])
