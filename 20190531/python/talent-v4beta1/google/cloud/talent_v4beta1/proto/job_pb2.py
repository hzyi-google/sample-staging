...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2.DESCRIPTOR,google_dot_protobuf_dot_timestamp__pb2.DESCRIPTOR,google_dot_protobuf_dot_wrappers__pb2.DESCRIPTOR,google_dot_type_dot_postal__address__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,])
...
Job = _reflection.GeneratedProtocolMessageType('Job', (_message.Message,), dict(
  ...
  Attributes:
      name:
          ...
          /api-test-project/jobs/1234".  Use of this field in job
          queries and API calls is preferred over the use of [requisitio
          n\_id][google.cloud.talent.v4beta1.Job.requisition\_id] since
