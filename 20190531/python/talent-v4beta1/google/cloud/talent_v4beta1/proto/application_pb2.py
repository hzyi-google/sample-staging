...
_APPLICATION.fields_by_name['interviews'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._INTERVIEW
...
_APPLICATION.fields_by_name['outcome'].enum_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._OUTCOME
...
Application = _reflection.GeneratedProtocolMessageType('Application', (_message.Message,), dict(
  ...
  Attributes:
      ...
      profile:
          ...
          enant\_id}/profiles/{profile\_id}", for example, "projects
          /api-test-project/tenants/foo/profiles/bar".
      job:
