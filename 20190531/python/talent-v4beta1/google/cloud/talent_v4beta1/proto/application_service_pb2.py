...
from google.cloud.talent_v4beta1.proto import application_pb2 as google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_application__pb2
...
_CREATEAPPLICATIONREQUEST.fields_by_name['application'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_application__pb2._APPLICATION
_UPDATEAPPLICATIONREQUEST.fields_by_name['application'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_application__pb2._APPLICATION
_UPDATEAPPLICATIONREQUEST.fields_by_name['update_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
_LISTAPPLICATIONSRESPONSE.fields_by_name['applications'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_application__pb2._APPLICATION
_LISTAPPLICATIONSRESPONSE.fields_by_name['metadata'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._RESPONSEMETADATA
...
DeleteApplicationRequest = _reflection.GeneratedProtocolMessageType('DeleteApplicationRequest', (_message.Message,), dict(
  ...
  Attributes:
      name:
          ...
          example, "projects/test-project/tenants/test-tenant/profiles
          /test-profile/applications/test-application".
  """,
...
ListApplicationsRequest = _reflection.GeneratedProtocolMessageType('ListApplicationsRequest', (_message.Message,), dict(
...
ListApplicationsResponse = _reflection.GeneratedProtocolMessageType('ListApplicationsResponse', (_message.Message,), dict(
...
_APPLICATIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002C\">/v4beta1/{parent=projects/*/tenants/*/profiles/*}/applications:\001*'),
  ),
  _descriptor.MethodDescriptor(
    name='GetApplication',
    ...
    output_type=google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_application__pb2._APPLICATION,
    serialized_options=_b('\202\323\344\223\002@\022>/v4beta1/{name=projects/*/tenants/*/profiles/*/applications/*}'),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_application__pb2._APPLICATION,
    serialized_options=_b('\202\323\344\223\002O2J/v4beta1/{application.name=projects/*/tenants/*/profiles/*/applications/*}:\001*'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002@*>/v4beta1/{name=projects/*/tenants/*/profiles/*/applications/*}'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002@\022>/v4beta1/{parent=projects/*/tenants/*/profiles/*}/applications'),
  ),
])
