...
_PROFILE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='resume', full_name='google.cloud.talent.v4beta1.Profile.resume', index=8,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='applications', full_name='google.cloud.talent.v4beta1.Profile.applications', index=22,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='assignments', full_name='google.cloud.talent.v4beta1.Profile.assignments', index=23,
...
_PROFILE.fields_by_name['skills'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._SKILL
...
_PROFILE.fields_by_name['certifications'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._CERTIFICATION
...
_ACTIVITY.fields_by_name['skills_used'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._SKILL
...
_PATENT.fields_by_name['skills_used'].message_type = google_dot_cloud_dot_talent__v4beta1_dot_proto_dot_common__pb2._SKILL
...
Phone = _reflection.GeneratedProtocolMessageType('Phone', (_message.Message,), dict(
  ...
  Attributes:
      ...
      number:
          ...
          a phone number in profile is provided in the format of "(xxx
          )xxx-xxxx", in profile searches the same phone format has to
