...
public final class CompletionGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.google.cloud.talent.v4beta1.CompleteQueryRequest,
      com.google.cloud.talent.v4beta1.CompleteQueryResponse> METHOD_COMPLETE_QUERY = getCompleteQueryMethodHelper();
  ...
  private static io.grpc.MethodDescriptor<com.google.cloud.talent.v4beta1.CompleteQueryRequest,
      com.google.cloud.talent.v4beta1.CompleteQueryResponse> getCompleteQueryMethodHelper() {
  ...
  public static final class CompletionStub extends io.grpc.stub.AbstractStub<CompletionStub> {
    ...
    @java.lang.Override
    protected CompletionStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
    ...
    public void completeQuery(com.google.cloud.talent.v4beta1.CompleteQueryRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.talent.v4beta1.CompleteQueryResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getCompleteQueryMethodHelper(), getCallOptions()), request, responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static final class CompletionBlockingStub extends io.grpc.stub.AbstractStub<CompletionBlockingStub> {
    ...
    @java.lang.Override
    protected CompletionBlockingStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
   ...
   * </pre>
   */
  public static final class CompletionFutureStub extends io.grpc.stub.AbstractStub<CompletionFutureStub> {
    ...
    @java.lang.Override
    protected CompletionFutureStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
