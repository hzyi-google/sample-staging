...
public final class ProfileResourceProto {
  ...
  static {
    ...
    internal_static_google_cloud_talent_v4beta1_Profile_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_talent_v4beta1_Profile_descriptor,
        new java.lang.String[] { "Name", "ExternalId", "Source", "Uri", "GroupId", "IsHirable", "CreateTime", "UpdateTime", "Resume", "PersonNames", "Addresses", "EmailAddresses", "PhoneNumbers", "PersonalUris", "AdditionalContactInfo", "EmploymentRecords", "EducationRecords", "Skills", "Activities", "Publications", "Patents", "Certifications", "Applications", "Assignments", "CustomAttributes", "Processed", "KeywordSnippet", });
    internal_static_google_cloud_talent_v4beta1_Profile_CustomAttributesEntry_descriptor =
