...
public class ColumnSpecName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/locations/{location}/datasets/{dataset}/tableSpecs/{table_spec}/columnSpecs/{column_spec}");
  ...
  public static ColumnSpecName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(formattedString, "ColumnSpecName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("dataset"), matchMap.get("table_spec"), matchMap.get("column_spec"));
  }
  ...
  public String toString() {
    return PATH_TEMPLATE.instantiate("project", project, "location", location, "dataset", dataset, "table_spec", tableSpec, "column_spec", columnSpec);
  }
