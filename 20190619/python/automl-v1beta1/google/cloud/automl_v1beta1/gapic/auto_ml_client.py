...
class AutoMlClient(object):
    ...
    @classmethod
    def column_spec_path(cls, project, location, dataset, table_spec,
                         column_spec):
    ...
    def create_dataset(self,
        ...
        return self._inner_api_calls['create_dataset'](request,
                                                       retry=retry,
                                                       timeout=timeout,
                                                       metadata=metadata)
    ...
    def update_dataset(self,
        ...
        if 'update_dataset' not in self._inner_api_calls:
            self._inner_api_calls[
                'update_dataset'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.update_dataset,
                    default_retry=self._method_configs['UpdateDataset'].retry,
                    default_timeout=self._method_configs['UpdateDataset'].
                    timeout,
                    client_info=self._client_info,
                )
        ...
        return self._inner_api_calls['update_dataset'](request,
                                                       retry=retry,
                                                       timeout=timeout,
                                                       metadata=metadata)
    ...
    def get_dataset(self,
        ...
        return self._inner_api_calls['get_dataset'](request,
                                                    retry=retry,
                                                    timeout=timeout,
                                                    metadata=metadata)
    ...
    def list_datasets(self,
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_datasets'],
                                     retry=retry,
                                     timeout=timeout,
                                     metadata=metadata),
            request=request,
    ...
    def delete_dataset(self,
        ...
        operation = self._inner_api_calls['delete_dataset'](request,
                                                            retry=retry,
                                                            timeout=timeout,
                                                            metadata=metadata)
    ...
    def import_data(self,
        ...
        operation = self._inner_api_calls['import_data'](request,
                                                         retry=retry,
                                                         timeout=timeout,
                                                         metadata=metadata)
        return google.api_core.operation.from_gapic(
    ...
    def export_data(self,
        ...
        operation = self._inner_api_calls['export_data'](request,
                                                         retry=retry,
                                                         timeout=timeout,
                                                         metadata=metadata)
        return google.api_core.operation.from_gapic(
    ...
    def create_model(self,
        ...
        operation = self._inner_api_calls['create_model'](request,
                                                          retry=retry,
                                                          timeout=timeout,
                                                          metadata=metadata)
        return google.api_core.operation.from_gapic(
    ...
    def get_model(self,
        ...
        return self._inner_api_calls['get_model'](request,
                                                  retry=retry,
                                                  timeout=timeout,
                                                  metadata=metadata)
    ...
    def list_models(self,
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_models'],
                                     retry=retry,
                                     timeout=timeout,
                                     metadata=metadata),
            request=request,
    ...
    def delete_model(self,
        ...
        operation = self._inner_api_calls['delete_model'](request,
                                                          retry=retry,
                                                          timeout=timeout,
                                                          metadata=metadata)
        return google.api_core.operation.from_gapic(
    ...
    def deploy_model(self,
        ...
        operation = self._inner_api_calls['deploy_model'](request,
                                                          retry=retry,
                                                          timeout=timeout,
                                                          metadata=metadata)
        return google.api_core.operation.from_gapic(
    ...
    def undeploy_model(self,
        ...
        operation = self._inner_api_calls['undeploy_model'](request,
                                                            retry=retry,
                                                            timeout=timeout,
                                                            metadata=metadata)
        return google.api_core.operation.from_gapic(
    ...
    def get_model_evaluation(self,
        ...
        return self._inner_api_calls['get_model_evaluation'](request,
                                                             retry=retry,
                                                             timeout=timeout,
                                                             metadata=metadata)
    ...
    def export_model(self,
        ...
        if 'export_model' not in self._inner_api_calls:
            self._inner_api_calls[
                'export_model'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.export_model,
                    default_retry=self._method_configs['ExportModel'].retry,
                    default_timeout=self._method_configs['ExportModel'].
                    timeout,
                    client_info=self._client_info,
                )
        ...
        operation = self._inner_api_calls['export_model'](request,
                                                          retry=retry,
                                                          timeout=timeout,
                                                          metadata=metadata)
        return google.api_core.operation.from_gapic(
    ...
    def export_evaluated_examples(
        ...
        if 'export_evaluated_examples' not in self._inner_api_calls:
            self._inner_api_calls[
                'export_evaluated_examples'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.export_evaluated_examples,
                    default_retry=self.
                    _method_configs['ExportEvaluatedExamples'].retry,
                    default_timeout=self.
                    _method_configs['ExportEvaluatedExamples'].timeout,
                    client_info=self._client_info,
                )
    ...
    def get_annotation_spec(self,
        ...
        if 'get_annotation_spec' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_annotation_spec'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_annotation_spec,
                    default_retry=self._method_configs['GetAnnotationSpec'].
                    retry,
                    default_timeout=self._method_configs['GetAnnotationSpec'].
                    timeout,
                    client_info=self._client_info,
                )
        ...
        return self._inner_api_calls['get_annotation_spec'](request,
                                                            retry=retry,
                                                            timeout=timeout,
                                                            metadata=metadata)
    ...
    def get_table_spec(self,
        ...
        if 'get_table_spec' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_table_spec'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_table_spec,
                    default_retry=self._method_configs['GetTableSpec'].retry,
                    default_timeout=self._method_configs['GetTableSpec'].
                    timeout,
                    client_info=self._client_info,
                )

        request = service_pb2.GetTableSpecRequest(
            name=name,
        ...
        return self._inner_api_calls['get_table_spec'](request,
                                                       retry=retry,
                                                       timeout=timeout,
                                                       metadata=metadata)
    ...
    def list_table_specs(self,
        ...
        if 'list_table_specs' not in self._inner_api_calls:
            self._inner_api_calls[
                'list_table_specs'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.list_table_specs,
                    default_retry=self._method_configs['ListTableSpecs'].retry,
                    default_timeout=self._method_configs['ListTableSpecs'].
                    timeout,
                    client_info=self._client_info,
                )
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_table_specs'],
                                     retry=retry,
                                     timeout=timeout,
                                     metadata=metadata),
            request=request,
    ...
    def update_table_spec(self,
        ...
        if 'update_table_spec' not in self._inner_api_calls:
            self._inner_api_calls[
                'update_table_spec'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.update_table_spec,
                    default_retry=self._method_configs['UpdateTableSpec'].
                    retry,
                    default_timeout=self._method_configs['UpdateTableSpec'].
                    timeout,
                    client_info=self._client_info,
                )
        ...
        return self._inner_api_calls['update_table_spec'](request,
                                                          retry=retry,
                                                          timeout=timeout,
                                                          metadata=metadata)
    ...
    def get_column_spec(self,
        ...
        if 'get_column_spec' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_column_spec'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_column_spec,
                    default_retry=self._method_configs['GetColumnSpec'].retry,
                    default_timeout=self._method_configs['GetColumnSpec'].
                    timeout,
                    client_info=self._client_info,
                )

        request = service_pb2.GetColumnSpecRequest(
            name=name,
            field_mask=field_mask,
        )
        if metadata is None:
        ...
        return self._inner_api_calls['get_column_spec'](request,
                                                        retry=retry,
                                                        timeout=timeout,
                                                        metadata=metadata)
    ...
    def list_column_specs(self,
        ...
        if 'list_column_specs' not in self._inner_api_calls:
            self._inner_api_calls[
                'list_column_specs'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.list_column_specs,
                    default_retry=self._method_configs['ListColumnSpecs'].
                    retry,
                    default_timeout=self._method_configs['ListColumnSpecs'].
                    timeout,
                    client_info=self._client_info,
                )
    ...
    def update_column_spec(self,
        ...
        if 'update_column_spec' not in self._inner_api_calls:
            self._inner_api_calls[
                'update_column_spec'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.update_column_spec,
                    default_retry=self._method_configs['UpdateColumnSpec'].
                    retry,
                    default_timeout=self._method_configs['UpdateColumnSpec'].
                    timeout,
                    client_info=self._client_info,
                )
        ...
        return self._inner_api_calls['update_column_spec'](request,
                                                           retry=retry,
                                                           timeout=timeout,
                                                           metadata=metadata)
