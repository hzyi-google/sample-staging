...
class TestAutoMlClient(object):
    def test_create_dataset(self):
        ...
        expected_request = service_pb2.CreateDatasetRequest(parent=parent,
                                                            dataset=dataset)
    ...
    def test_create_model(self):
        ...
        assert len(channel.requests) == 1
        expected_request = service_pb2.CreateModelRequest(parent=parent,
                                                          model=model)
        actual_request = channel.requests[0][1]
        assert expected_request == actual_request
    ...
    def test_export_evaluated_examples_exception(self):
        ...
        error = status_pb2.Status()
        operation = operations_pb2.Operation(
            name='operations/test_export_evaluated_examples_exception',
            done=True)
        operation.error.CopyFrom(error)
    ...
    def test_get_annotation_spec(self):
        ...
        expected_response = annotation_spec_pb2.AnnotationSpec(
            **expected_response)
        ...
        # Setup Request
        name = client.annotation_spec_path('[PROJECT]', '[LOCATION]',
                                           '[DATASET]', '[ANNOTATION_SPEC]')
    ...
    def test_list_table_specs(self):
        ...
        expected_response = service_pb2.ListTableSpecsResponse(
            **expected_response)
    ...
    def test_update_table_spec(self):
        ...
        assert len(channel.requests) == 1
        expected_request = service_pb2.UpdateTableSpecRequest(
    ...
    def test_get_column_spec(self):
        ...
        # Setup Request
        name = client.column_spec_path('[PROJECT]', '[LOCATION]', '[DATASET]',
                                       '[TABLE_SPEC]', '[COLUMN_SPEC]')
    ...
    def test_list_column_specs(self):
        ...
        expected_response = service_pb2.ListColumnSpecsResponse(
            **expected_response)
        ...
        # Setup Request
        parent = client.table_spec_path('[PROJECT]', '[LOCATION]', '[DATASET]',
                                        '[TABLE_SPEC]')
    ...
    def test_update_column_spec(self):
        ...
        assert len(channel.requests) == 1
        expected_request = service_pb2.UpdateColumnSpecRequest(
