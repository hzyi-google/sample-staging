...
`Cloud AutoML API`_: Train high-quality custom machine learning models with minimum effort and
...
.. _Client Library Documentation: https://googleapis.github.io/google-cloud-python/latest/automl/usage.html
