...
describe('AutoMlClient', () => {
  ...
  describe('deployModel', function() {
    it('invokes deployModel without error', done => {
      ...
      // Mock Grpc layer
      client._innerApiCalls.deployModel = mockLongRunningGrpcMethod(request, expectedResponse);

      client.deployModel(request).then(responses => {
        const operation = responses[0];
        return operation.promise();
      }).then(responses => {
        assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    it('invokes deployModel with error', done => {
      ...
      // Mock Grpc layer
      client._innerApiCalls.deployModel = mockLongRunningGrpcMethod(request, null, error);
    ...
    it('has longrunning decoder functions', () => {
      ...
      assert(client._descriptors.longrunning.deployModel.responseDecoder instanceof Function);
      assert(client._descriptors.longrunning.deployModel.metadataDecoder instanceof Function);
    });
  });
  ...
  describe('undeployModel', function() {
    it('invokes undeployModel without error', done => {
      ...
      // Mock Grpc layer
      client._innerApiCalls.undeployModel = mockLongRunningGrpcMethod(request, expectedResponse);

      client.undeployModel(request).then(responses => {
        const operation = responses[0];
        return operation.promise();
      }).then(responses => {
        assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    it('invokes undeployModel with error', done => {
      ...
      // Mock Grpc layer
      client._innerApiCalls.undeployModel = mockLongRunningGrpcMethod(request, null, error);
    ...
    it('has longrunning decoder functions', () => {
      ...
      assert(client._descriptors.longrunning.undeployModel.responseDecoder instanceof Function);
      assert(client._descriptors.longrunning.undeployModel.metadataDecoder instanceof Function);
    });
  });
  ...
  describe('exportModel', function() {
    it('invokes exportModel without error', done => {
      ...
      // Mock Grpc layer
      client._innerApiCalls.exportModel = mockLongRunningGrpcMethod(request, expectedResponse);

      client.exportModel(request).then(responses => {
        const operation = responses[0];
        return operation.promise();
      }).then(responses => {
        assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    it('invokes exportModel with error', done => {
      ...
      // Mock Grpc layer
      client._innerApiCalls.exportModel = mockLongRunningGrpcMethod(request, null, error);
    ...
    it('has longrunning decoder functions', () => {
      ...
      assert(client._descriptors.longrunning.exportModel.responseDecoder instanceof Function);
      assert(client._descriptors.longrunning.exportModel.metadataDecoder instanceof Function);
    });
  });
  ...
  describe('exportEvaluatedExamples', function() {
    it('invokes exportEvaluatedExamples without error', done => {
      ...
      // Mock Grpc layer
      client._innerApiCalls.exportEvaluatedExamples = mockLongRunningGrpcMethod(request, expectedResponse);

      client.exportEvaluatedExamples(request).then(responses => {
        const operation = responses[0];
        return operation.promise();
      }).then(responses => {
        assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    it('invokes exportEvaluatedExamples with error', done => {
      ...
      // Mock Grpc layer
      client._innerApiCalls.exportEvaluatedExamples = mockLongRunningGrpcMethod(request, null, error);
    ...
    it('has longrunning decoder functions', () => {
      ...
      assert(client._descriptors.longrunning.exportEvaluatedExamples.responseDecoder instanceof Function);
      assert(client._descriptors.longrunning.exportEvaluatedExamples.metadataDecoder instanceof Function);
    });
  });
  ...
  describe('listTableSpecs', () => {
    it('invokes listTableSpecs without error', done => {
      ...
      // Mock Grpc layer
      client._innerApiCalls.listTableSpecs = (actualRequest, options, callback) => {
        assert.deepStrictEqual(actualRequest, request);
  ...
  describe('listColumnSpecs', () => {
    it('invokes listColumnSpecs without error', done => {
      ...
      // Mock Grpc layer
      client._innerApiCalls.listColumnSpecs = (actualRequest, options, callback) => {
        assert.deepStrictEqual(actualRequest, request);
...
describe('PredictionServiceClient', () => {
  it('has servicePath', () => {
    const servicePath = automlModule.v1beta1.PredictionServiceClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint = automlModule.v1beta1.PredictionServiceClient.apiEndpoint;
    assert(apiEndpoint);
  });
  ...
  describe('batchPredict', function() {
    it('invokes batchPredict without error', done => {
      ...
      // Mock Grpc layer
      client._innerApiCalls.batchPredict = mockLongRunningGrpcMethod(request, expectedResponse);

      client.batchPredict(request).then(responses => {
        const operation = responses[0];
        return operation.promise();
      }).then(responses => {
        assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    it('invokes batchPredict with error', done => {
      ...
      // Mock Grpc layer
      client._innerApiCalls.batchPredict = mockLongRunningGrpcMethod(request, null, error);
    ...
    it('has longrunning decoder functions', () => {
      ...
      assert(client._descriptors.longrunning.batchPredict.responseDecoder instanceof Function);
      assert(client._descriptors.longrunning.batchPredict.metadataDecoder instanceof Function);
    });
  });
