...
class AutoMlClient {
  ...
  matchProjectFromAnnotationSpecName(annotationSpecName) {
    return this._pathTemplates.annotationSpecPathTemplate
      .match(annotationSpecName)
      .project;
  }
  ...
  matchProjectFromColumnSpecName(columnSpecName) {
    return this._pathTemplates.columnSpecPathTemplate
      .match(columnSpecName)
      .project;
  }
  ...
  matchProjectFromTableSpecName(tableSpecName) {
    return this._pathTemplates.tableSpecPathTemplate
      .match(tableSpecName)
      .project;
  }
