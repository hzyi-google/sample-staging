...
require "google/cloud/automl/v1_beta1/credentials"
      ...
      module V1Beta1
        ...
        class AutoMlClient
          ...
          def initialize \
            ...
            package_version = Gem.loaded_specs['google-cloud-automl'].version.version
            ...
            @auto_ml_stub = Google::Gax::Grpc.create_stub(
              service_path,
              port,
            ...
            @create_dataset = Google::Gax.create_api_call(
              @auto_ml_stub.method(:create_dataset),
            ...
            @update_dataset = Google::Gax.create_api_call(
              @auto_ml_stub.method(:update_dataset),
            ...
            @get_dataset = Google::Gax.create_api_call(
              @auto_ml_stub.method(:get_dataset),
            ...
            @list_datasets = Google::Gax.create_api_call(
              @auto_ml_stub.method(:list_datasets),
            ...
            @delete_dataset = Google::Gax.create_api_call(
              @auto_ml_stub.method(:delete_dataset),
            ...
            @import_data = Google::Gax.create_api_call(
              @auto_ml_stub.method(:import_data),
            ...
            @export_data = Google::Gax.create_api_call(
              @auto_ml_stub.method(:export_data),
            ...
            @create_model = Google::Gax.create_api_call(
              @auto_ml_stub.method(:create_model),
            ...
            @list_models = Google::Gax.create_api_call(
              @auto_ml_stub.method(:list_models),
            ...
            @delete_model = Google::Gax.create_api_call(
              @auto_ml_stub.method(:delete_model),
            ...
            @deploy_model = Google::Gax.create_api_call(
              @auto_ml_stub.method(:deploy_model),
            ...
            @undeploy_model = Google::Gax.create_api_call(
              @auto_ml_stub.method(:undeploy_model),
            ...
            @get_model_evaluation = Google::Gax.create_api_call(
              @auto_ml_stub.method(:get_model_evaluation),
            ...
            @export_model = Google::Gax.create_api_call(
              @auto_ml_stub.method(:export_model),
            ...
            @export_evaluated_examples = Google::Gax.create_api_call(
              @auto_ml_stub.method(:export_evaluated_examples),
            ...
            @list_model_evaluations = Google::Gax.create_api_call(
              @auto_ml_stub.method(:list_model_evaluations),
            ...
            @get_annotation_spec = Google::Gax.create_api_call(
              @auto_ml_stub.method(:get_annotation_spec),
            ...
            @get_table_spec = Google::Gax.create_api_call(
              @auto_ml_stub.method(:get_table_spec),
            ...
            @list_table_specs = Google::Gax.create_api_call(
              @auto_ml_stub.method(:list_table_specs),
            ...
            @update_table_spec = Google::Gax.create_api_call(
              @auto_ml_stub.method(:update_table_spec),
            ...
            @get_column_spec = Google::Gax.create_api_call(
              @auto_ml_stub.method(:get_column_spec),
            ...
            @list_column_specs = Google::Gax.create_api_call(
              @auto_ml_stub.method(:list_column_specs),
            ...
            @update_column_spec = Google::Gax.create_api_call(
              @auto_ml_stub.method(:update_column_spec),
          ...
          #   # TODO: Initialize `dataset`:
          #   dataset = {}
          #   response = auto_ml_client.update_dataset(dataset)
          ...
          #   response = auto_ml_client.get_dataset(formatted_name)
          ...
          #   auto_ml_client.list_datasets(formatted_parent).each do |element|
          #     # Process element.
          #   end
          #
          #   # Or iterate over results one page at a time.
          #   auto_ml_client.list_datasets(formatted_parent).each_page do |page|
          ...
          #   operation = auto_ml_client.delete_dataset(formatted_name) do |op|
          ...
          #
          #   # Register a callback during the method call.
          #   operation = auto_ml_client.import_data(formatted_name, input_config) do |op|
          #     raise op.results.message if op.error?
          #     op_results = op.results
          #     # Process the results.
          #
          ...
          #
          #   # Register a callback during the method call.
          #   operation = auto_ml_client.export_data(formatted_name, output_config) do |op|
          #     raise op.results.message if op.error?
          #     op_results = op.results
          #     # Process the results.
          #
          ...
          #
          #   # Register a callback during the method call.
          #   operation = auto_ml_client.create_model(formatted_parent, model) do |op|
          #     raise op.results.message if op.error?
          #     op_results = op.results
          #     # Process the results.
          #
          ...
          #   response = auto_ml_client.get_model(formatted_name)
          ...
          #
          #   # Iterate over all results.
          #   auto_ml_client.list_models(formatted_parent).each do |element|
          #     # Process element.
          #   end
          #
          #   # Or iterate over results one page at a time.
          #   auto_ml_client.list_models(formatted_parent).each_page do |page|
          #     # Process each page at a time.
          #     page.each do |element|
          #       # Process element.
          #     end
          ...
          #
          #   # Register a callback during the method call.
          #   operation = auto_ml_client.delete_model(formatted_name) do |op|
          #     raise op.results.message if op.error?
          #     op_results = op.results
          #     # Process the results.
          #
          ...
          #
          #   # Register a callback during the method call.
          #   operation = auto_ml_client.deploy_model(formatted_name) do |op|
          #     raise op.results.message if op.error?
          #     op_results = op.results
          #     # Process the results.
          #
          ...
          #
          #   # Register a callback during the method call.
          #   operation = auto_ml_client.undeploy_model(formatted_name) do |op|
          #     raise op.results.message if op.error?
          #     op_results = op.results
          #     # Process the results.
          #
          ...
          #   response = auto_ml_client.get_model_evaluation(formatted_name)
          ...
          #
          #   # Register a callback during the method call.
          #   operation = auto_ml_client.export_model(formatted_name, output_config) do |op|
          #     raise op.results.message if op.error?
          #     op_results = op.results
          #     # Process the results.
          #
          ...
          #
          #   # Register a callback during the method call.
          #   operation = auto_ml_client.export_evaluated_examples(formatted_name, output_config) do |op|
          #     raise op.results.message if op.error?
          #     op_results = op.results
          #     # Process the results.
          #
          ...
          #
          #   # Iterate over all results.
          #   auto_ml_client.list_model_evaluations(formatted_parent).each do |element|
          #     # Process element.
          #   end
          #
          #   # Or iterate over results one page at a time.
          #   auto_ml_client.list_model_evaluations(formatted_parent).each_page do |page|
          #     # Process each page at a time.
          #     page.each do |element|
          #       # Process element.
          #     end
          ...
          #   response = auto_ml_client.get_annotation_spec(formatted_name)
          ...
          #   response = auto_ml_client.get_table_spec(formatted_name)
          ...
          #
          #   # Iterate over all results.
          #   auto_ml_client.list_table_specs(formatted_parent).each do |element|
          #     # Process element.
          #   end
          #
          #   # Or iterate over results one page at a time.
          #   auto_ml_client.list_table_specs(formatted_parent).each_page do |page|
          #     # Process each page at a time.
          #     page.each do |element|
          #       # Process element.
          #     end
          ...
          #   table_spec = {}
          #   response = auto_ml_client.update_table_spec(table_spec)
          ...
          #   response = auto_ml_client.get_column_spec(formatted_name)
          ...
          #
          #   # Iterate over all results.
          #   auto_ml_client.list_column_specs(formatted_parent).each do |element|
          #     # Process element.
          #   end
          #
          #   # Or iterate over results one page at a time.
          #   auto_ml_client.list_column_specs(formatted_parent).each_page do |page|
          #     # Process each page at a time.
          #     page.each do |element|
          #       # Process element.
          #     end
          ...
          #   column_spec = {}
          #   response = auto_ml_client.update_column_spec(column_spec)
