...
public final class TaskProto {
  ...
  static {
    ...
    internal_static_google_cloud_tasks_v2_Task_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_tasks_v2_Task_descriptor,
        new java.lang.String[] { "Name", "AppEngineHttpRequest", "ScheduleTime", "CreateTime", "DispatchDeadline", "DispatchCount", "ResponseCount", "FirstAttempt", "LastAttempt", "View", "MessageType", });
    internal_static_google_cloud_tasks_v2_Attempt_descriptor =
